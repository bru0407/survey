        ...
        <div class="createsurvey-page">
          ...
          <fieldset class="create">
            ...
            <div class="form-group <?php echo (!empty($start_err)) ? 'has-error' : ''; ?>">
              ...
              <input type="date" class="datepicker" id="start" name="start" placeholder="Enter survey starting date.">
            </div>
            <br>
            ...
            <div class="form-group <?php echo (!empty($end_err)) ? 'has-error' : ''; ?>">
              ...
              <input type="text" class="datepicker" id="end" name="end" placeholder="Enter survey ending date.">
            </div>
